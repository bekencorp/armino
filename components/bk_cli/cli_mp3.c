...
extern void cli_aud_intf_mp3_play_test_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
extern void cli_http_mp3_play_test_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
...
static const struct cli_command s_mp3_commands[] = {
	...
	{"http_mp3_play", "http_mp3_play {uri}", cli_http_mp3_play_test_cmd},
};
