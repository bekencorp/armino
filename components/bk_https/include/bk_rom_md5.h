...
#define BK_ROM_MD5_DIGEST_LEN 16
 ...
 */
void bk_rom_md5_init(md5_context_t *context);
 ...
 */
void bk_rom_md5_update(md5_context_t *context, const void *buf, uint32_t len);
 ...
 */
void bk_rom_md5_final(uint8_t *digest, md5_context_t *context);
