...
PPPP_API_API INT32 PPCS_Connect_fake(const CHAR *TargetID, CHAR bEnableLanSearch, UINT16 UDP_Port);
PPPP_API_API INT32 PPCS_ConnectByServer_fake(const CHAR *TargetID, CHAR bEnableLanSearch, UINT16 UDP_Port, CHAR *ServerString);
PPPP_API_API INT32 PPCS_Connect_Break_fake();

#define PPCS_Connect PPCS_Connect_fake
#define PPCS_ConnectByServer PPCS_ConnectByServer_fake
#define PPCS_Connect_Break PPCS_Connect_Break_fake
...
PPPP_API_API INT32 PPCS_Listen_fake(const CHAR *MyID, const UINT32 TimeOut_Sec, UINT16 UDP_Port, CHAR bEnableInternet, const CHAR* APILicense);
PPPP_API_API INT32 PPCS_Listen_Break_fake(void);

#define PPCS_Listen PPCS_Listen_fake
#define PPCS_Listen_Break PPCS_Listen_Break_fake

#else

#error "you must define CONFIG_CS2_P2P_SERVER OR CONFIG_CS2_P2P_CLIENT"
