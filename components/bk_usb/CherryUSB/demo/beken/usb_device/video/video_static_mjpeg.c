...
const uint8_t video_descriptor[] = {
    ...
    VIDEO_VC_DESCRIPTOR_INIT(0x00, 0x01, 0x0100, VC_TERMINAL_SIZ, 48000000, 0x02),
    ...
    WBVAL(0x0010),                /* wMaxPacketSize: 16 bytes */
    0x01,                         /* bInterval: One frame interval */

    /* Class-specific VC Interrupt Endpoint Descriptor */
    0x05,                            /* bLength */
    USB_CS_DESCRIPTOR_TYPE_ENDPOINT, /* bDescriptorType: CS_ENDPOINT */
