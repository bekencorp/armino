...
#define VS_HEADER_SIZ   (unsigned int)(15 + 0x1c + 30 + 30 + 30 + 0x0b + 0x1e + 0x1e)
...
const uint8_t video_descriptor[] = {
    ...
    VIDEO_VS_FORMAT_H264_DESCRIPTOR_INIT(0x01, 0x03),
    ...
    VIDEO_VS_FRAME_H264_DESCRIPTOR_INIT(0x03, 1280, 720, MIN_BIT_RATE, MAX_BIT_RATE, DBVAL(INTERVAL), 0x01, DBVAL(INTERVAL)),
    VIDEO_VS_FORMAT_MJPEG_DESCRIPTOR_INIT(0x02, 0x02),
    VIDEO_VS_FRAME_MJPEG_DESCRIPTOR_INIT(0x01, 640, 480, MIN_BIT_RATE, MAX_BIT_RATE, MAX_FRAME_SIZE, DBVAL(INTERVAL), 0x01, DBVAL(INTERVAL)),
    VIDEO_VS_FRAME_MJPEG_DESCRIPTOR_INIT(0x02, 1280, 720, MIN_BIT_RATE, MAX_BIT_RATE, MAX_FRAME_SIZE, DBVAL(INTERVAL), 0x01, DBVAL(INTERVAL)),
