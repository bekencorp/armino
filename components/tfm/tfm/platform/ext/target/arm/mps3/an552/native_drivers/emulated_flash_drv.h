 ...
 */
enum emulated_flash_error_t
emulated_flash_read_data(struct emulated_flash_dev_t* dev, uint32_t addr,
 ...
 */
enum emulated_flash_error_t
emulated_flash_program_data(struct emulated_flash_dev_t* dev, uint32_t addr,
 ...
 */
enum emulated_flash_error_t
emulated_flash_erase_sector(struct emulated_flash_dev_t* dev, uint32_t addr);
 ...
 */
ARM_FLASH_INFO*
emulated_flash_get_info(struct emulated_flash_dev_t* dev);
