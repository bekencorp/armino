 ...
 */
/* ISRAM1 (offsets) */
/* 0x0000_0000 Secure image     secondary slot (384 KB)
 * 0x0006_0000 Non-secure image secondary slot (384 KB)
 * 0x000C_0000 Scratch area (192 KB)
 * 0x000F_0000 Protected Storage Area (20 KB)
 * 0x000F_5000 Internal Trusted Storage Area (16 KB)
 * 0x000F_9000 OTP / NV counters  area (8 KB)
 * 0x000F_B000 Unused
 */
 ...
 */
 /* ISRAM1 (offsets) */
 /* 0x0000_0000 Secondary image area (768 KB):
 *    0x0000_0000 Secure     image secondary (384 KB)
 *    0x0006_0000 Non-secure image secondary (384 KB)
 * 0x000C_0000 Scratch area (192 KB)
 * 0x000F_0000 Protected Storage Area (20 KB)
 * 0x000F_5000 Internal Trusted Storage Area (16 KB)
 * 0x000F_9000 OTP / NV counters  area (8 KB)
...
#define FLASH0_BASE_ADDRESS              (SRAM_BASE_S)
#define FLASH1_BASE_ADDRESS              (ISRAM1_BASE_S)
 ...
 * in SRAM area. */
#if ( FLASH_AREA_2_OFFSET + FLASH_AREA_2_SIZE > SRAM_SIZE)
...
/* mpc_init_cfg function in target_cfg.c expects that all the images can fit
 * in SRAM area. */
#if ( FLASH_AREA_1_OFFSET + FLASH_AREA_1_SIZE > SRAM_SIZE)
#error "Out of SRAM memory!"
#endif
...
#if ( FLASH_OTP_NV_COUNTERS_AREA_OFFSET + FLASH_OTP_NV_COUNTERS_AREA_SIZE > ISRAM1_SIZE)
#error "Out of ISRAM1 memory!"
#endif
