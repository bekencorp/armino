...
#define FLASH_AREA_PRIMARY_MANIFEST_OFFSET        CONFIG_PRIMARY_MANIFEST_PHY_PARTITION_OFFSET
#define FLASH_AREA_PRIMARY_MANIFEST_SIZE          CONFIG_PRIMARY_MANIFEST_PHY_PARTITION_SIZE

#define FLASH_AREA_SECONDARY_MANIFEST_ID          (FLASH_AREA_PRIMARY_MANIFEST_ID + 1)
#define FLASH_AREA_SECONDARY_MANIFEST_OFFSET      CONFIG_SECONDARY_MANIFEST_PHY_PARTITION_OFFSET
#define FLASH_AREA_SECONDARY_MANIFEST_SIZE        CONFIG_SECONDARY_MANIFEST_PHY_PARTITION_SIZE

#define FLASH_AREA_PRIMARY_BL2_ID                 (FLASH_AREA_SECONDARY_MANIFEST_ID + 1)
#define FLASH_AREA_PRIMARY_BL2_OFFSET             CONFIG_PRIMARY_BL2_PHY_PARTITION_OFFSET
#define FLASH_AREA_PRIMARY_BL2_SIZE               CONFIG_PRIMARY_BL2_PHY_PARTITION_SIZE
