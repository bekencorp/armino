...
#define FLASH0_BASE_S                  SOC_S_BASE(SOC_FLASH_DATA_BASE)
#define FLASH0_BASE_NS                 SOC_NS_BASE(SOC_FLASH_DATA_BASE)
...
#define UART0_BASE_S                   SOC_S_BASE(SOC_UART0_REG_BASE)
#define UART0_BASE_NS                  SOC_NS_BASE(SOC_UART0_REG_BASE)
