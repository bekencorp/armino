...
typedef struct
{
    UART_T* dev;      /* UART device structure */
                               ...
                               uint32_t num)
{
    ...
    while((uart_dev->dev->FIFOSTS & UART_FIFOSTS_TXEMPTY_Msk) == 0);
