 ...
 * @copyright Copyright (C) 2018-2020 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
...
/**
  * @details    Global USBD data for SecureISP USB
        This data is internal use in SecureISP operation
  */
#pragma pack(push)
#pragma pack(1)
typedef struct
...
/**
  ...
  *             User can use SecureISP Tool to communicate with target chip.
        Configure relate USB and UART1 settings are necessary before executing this API.
  */
