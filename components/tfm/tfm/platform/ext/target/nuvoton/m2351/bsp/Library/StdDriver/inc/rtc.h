 ...
 * @copyright Copyright (C) 2016-2020 Nuvoton Technology Corp. All rights reserved.
 *****************************************************************************/
#ifndef __RTC_H__
#define __RTC_H__
...
/**
  ...
  * @details    Read the specify spare register content.
        The returned value is valid only when RWENF (RTC_RWEN[16]) bit is set. \n
  * \hideinitializer
  */
...
/**
  ...
  * @details    Write specify data to spare register.
        This macro is effect only when RWENF (RTC_RWEN[16]) bit is set. \n
  * \hideinitializer
  */
