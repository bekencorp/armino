...
/**
  ...
  * @details    This macro is used to enable output function of specified output pins.
        If the corresponding bit in u32ChMask parameter is 0, then output function will be disabled in this channel.
  * \hideinitializer
  */
...
/**
  ...
  * @details    This macro is used to enable output inverse of specified output pins.
        If u32ChMask parameter is 0, then output inverse function will be disabled.
  * \hideinitializer
  */
...
/**
  ...
  *
  * @details    This macro is used to enable output function of specified output pins.
        If u32ChMask parameter is 0, then output mask function will be disabled.
  * \hideinitializer
  */
...
/**
  ...
  * @details    This macro is used to set counter synchronous mode of specified Timer PWM module.
        Only support all PWM counters are synchronous by TIMER0 PWM or TIMER0~1 PWM counter synchronous by TIMER0 PWM and
