 ...
 * @details     This function enable timeout function of the selected channel(s).
        This function is only supported in channel 0 and channel 1.
 */
 ...
 * @details     This function enable the selected channel interrupt.
        PDMA_INT_TIMEOUT is only supported in channel 0 and channel 1.
 */
 ...
 * @details     This function disable the selected channel interrupt.
        PDMA_INT_TIMEOUT is only supported in channel 0 and channel 1.
        The transfer done interrupt is disabled when table empty interrupt is disabled(PDMA_INT_TEMPTY).
 */
