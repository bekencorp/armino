...
/**
  ...
  *             If timer cannot work in target frequency, a closest frequency will be chose and returned.
        After calling this API, Timer is \b NOT running yet. But could start timer running be calling
...
/**
  ...
  *             to get current counter value or reset counter value to 0.
        Timer frequency should be configured separately by using \ref TIMER_Open API, or program registers directly.
  */
...
/**
  ...
  * @details    This function is used to enable the timer counter function with specify detection edge.
        Timer compare value should be configured separately by using \ref TIMER_SET_CMP_VALUE macro or program registers directly.
        While using event counter function, \ref TIMER_TOGGLE_MODE cannot set as timer operation mode.
  */
