...
/* Same as FLASH0_SIZE */
#define FLASH_TOTAL_SIZE                (0x00080000) /* 512 KB */
...
#define FLASH_AREA_0_OFFSET        (FLASH_AREA_BL2_OFFSET + FLASH_AREA_BL2_SIZE + 0x8000)        /* 0x10000 */
...
#define TOTAL_RAM_SIZE (0x00018000)     /* 96 KB */
