...
__STATIC_INLINE void FMC_NSBA_Setup(void)
{
    ...
    if(SCU->FNSADDR != FMC_SECURE_ROM_SIZE)
    {
        ...
        /* Fatal Error:
           ...
           If user need to change NSBA config of FMC, user must do Mass-erase by
           ISP or ICP.
        */
        while(1);
    }
...
//   </h>
*/
#define SCU_INIT_PNSSET3_VAL      0x10004
/*
    PNSSET4
*/
/*
...
*/
#define SCU_INIT_IONSSET_VAL      0x1
/*
// </h>
*/
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1     0x10060000
/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
