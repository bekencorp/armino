...
#define DBH_OTP_TEST_REGION_SIZE ( 0x10 * DBH_OTP_WORD_SIZE )

/* User defined region 8 bytes default */
#define DBH_OTP_USR_NON_SEC_REGION_SIZE ( 0x2UL * DBH_OTP_WORD_SIZE )
#define DBH_OTP_USR_SEC_REGION_SIZE ( 0x2UL * DBH_OTP_WORD_SIZE )
