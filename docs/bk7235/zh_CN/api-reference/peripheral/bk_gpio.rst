...
+==============================================+=========+=========+========+
| :cpp:func:`bk_gpio_driver_init`              | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_driver_deinit`            | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_enable_output`            | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_disable_output`           | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_enable_input`             | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_disable_input`            | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_enable_pull`              | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_disable_pull`             | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_pull_up`                  | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_pull_down`                | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_set_output_high`          | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_set_output_low`           | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_get_input`                | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_set_config`               | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_register_isr`             | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_enable_interrupt`         | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
| :cpp:func:`bk_gpio_disable_interrupt`        | Y       | Y       | Y      |
+----------------------------------------------+---------+---------+--------+
