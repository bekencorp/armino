...
Design Description
+++++++++++++++++++++
The security function of BK7236 is based on BK130, which implements security boot, flash encryption and decryption.
 ...
 The following five steps are required to use the security function of BK7236:
...
For example::
    ...
    Generate AES key：cmake_xte_aes.exe genkey  -version 123 -outfile bk7236.txt
    Image encryption：cmake_xte_aes.exe encrypt -infile all.bin -startaddress 0 -keyfile 123_bk7236.txt -outfile all_enc.bin
