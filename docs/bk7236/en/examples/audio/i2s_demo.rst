...
+=====================+==============================+===================================================+=====+
|CONFIG_I2S           |Configure I2S function enable |``\properties\soc\bk7236_cp1\bk7236_cp1.defconfig``|  y  |
+---------------------+------------------------------+---------------------------------------------------+-----+
|CONFIG_I2S_TEST      |Configure demo enable         |``\properties\soc\bk7236_cp1\bk7236_cp1.defconfig``|  y  |
+---------------------+------------------------------+---------------------------------------------------+-----+
