...
#else       /*LV_MEM_CUSTOM*/
void *os_malloc_debug(const char *func_name, int line, unsigned int size, int need_zero);
void *psram_malloc_debug(const char *func_name, int line, unsigned int size, int need_zero);
...
void *os_realloc(void *ptr, uint32_t size);
