...
#define SOC_SRAM2_DATA_BASE      (0x28020000 + SOC_ADDR_OFFSET) //64K
...
#define SOC_H264_REG_BASE        (0x48080000 + SOC_ADDR_OFFSET)
...
#define SOC_DMA2D_REG_BASE       (0x48020000 + SOC_ADDR_OFFSET)
