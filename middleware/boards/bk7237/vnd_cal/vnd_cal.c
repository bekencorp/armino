...
TXPWR_ST gtxpwr_tab_def_b_overlay[WLAN_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(21, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(21, TXPWR_ELEM_INUSED),  // ch13  inused
    INIT_TXPWR_VALUE(21, TXPWR_ELEM_UNUSED),
};
...
TXPWR_ST gtxpwr_tab_def_ble_overlay[BLE_2_4_G_CHANNEL_NUM] = {
    ...
    INIT_TXPWR_VALUE(40, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_INUSED),  // ch19 2440 inused
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(42, TXPWR_ELEM_UNUSED),  // ch24 2450
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),  // ch29 2460
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),  // ch34 2470
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(44, TXPWR_ELEM_UNUSED),  // ch39 2480 inused
};
