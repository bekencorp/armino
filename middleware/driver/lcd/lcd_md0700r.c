...
{
	os_printf("lcd_md0700r: backlight open.\r\n");
#if CONFIG_PWM
	os_printf("lcd_md0700r: backlight pwm init.\r\n");
...
const lcd_device_t lcd_device_md0700r =
{
	.id = LCD_DEVICE_MD0700R,
	.name = "md0700r",
