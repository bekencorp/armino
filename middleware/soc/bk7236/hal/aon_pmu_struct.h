...
typedef volatile struct {
    ...
    { 
        ...
        { 
           ...
           volatile uint32_t  halt_volt                      : 1;  //0x40[24],volt   when halt,None,R/W
           volatile uint32_t  halt_xtal                      : 1;  //0x40[25],xtal   when halt,None,R/W
           volatile uint32_t  halt_core                      : 1;  //0x40[26],core   when halt,None,R/W
           volatile uint32_t  halt_flash                     : 1;  //0x40[27],flash  when halt,None,R/W
           volatile uint32_t  halt_rosc                      : 1;  //0x40[28],rosc   when halt,None,R/W
           volatile uint32_t  halt_resten                    : 1;  //0x40[29],resten when halt,None,R/W
           volatile uint32_t  halt_isolat                    : 1;  //0x40[30],isolat when halt,None,R/W
           volatile uint32_t  halt_clkena                    : 1;  //0x40[31],clkena when halt,None,R/W
        }; 
        uint32_t v; 
    }reg40; 
    ...
    { 
        struct 
        { 
           volatile uint32_t  clr_int_touched                :16;  //0x43[15:0], ,None,R/W
           volatile uint32_t  clr_int_usbplug                : 1;  //0x43[16], ,None,R/W
    ...
    { 
        struct 
        { 
           volatile uint32_t  int_touched                    :16;  //0x70[15:0], ,None,R/W
           volatile uint32_t  int_usbplug                    : 1;  //0x70[16], ,None,R/W
    ...
    { 
        struct 
        { 
           volatile uint32_t  touch_state                    :16;  //0x71[15:0], ,None,R/W
           volatile uint32_t  usbplug_state                  : 1;  //0x71[16], ,None,R/W
           volatile uint32_t  reserved0                      : 3;  //0x71[19:17],reserved,None,R
           volatile uint32_t  wakeup_source                  : 5;  //0x71[24:20], ,None,R/W
    ...
    { 
        ...
        { 
           ...
           volatile uint32_t  mpll_unlock                    : 1;  //0x7d[31], ,None,R
        }; 
        uint32_t v; 
    }reg7d; 
