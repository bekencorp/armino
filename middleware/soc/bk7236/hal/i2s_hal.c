...
bk_err_t i2s_hal_deconfig(void)
{
	...
	i2s_ll_set_pcm_cn_lt2_value(0, i2s_cfg_index);
	i2s_ll_clear_pcm_stat_lt2_rx2ovf(i2s_cfg_index);
	i2s_ll_clear_pcm_stat_lt2_tx2udf(i2s_cfg_index);
	i2s_ll_set_pcm_dat2_value(0, i2s_cfg_index);
	i2s_ll_set_pcm_dat3_value(0, i2s_cfg_index);
	i2s_ll_set_pcm_dat4_value(0, i2s_cfg_index);
...
bk_err_t i2s_hal_int_status_get(i2s_int_status_t *int_status)
{
	switch(int_status->channel_id)
	{
		case I2S_CHANNEL_1:
			...
			break;
		case I2S_CHANNEL_2:
			int_status->tx_udf = (bool)i2s_ll_get_pcm_stat_lt2_tx2udf(i2s_cfg_index);
			int_status->rx_ovf = (bool)i2s_ll_get_pcm_stat_lt2_rx2ovf(i2s_cfg_index);
			int_status->tx_int = (bool)i2s_ll_get_pcm_stat_lt2_tx2int(i2s_cfg_index);
			int_status->rx_int = (bool)i2s_ll_get_pcm_stat_lt2_rx2int(i2s_cfg_index);
			break;
		case I2S_CHANNEL_3:
			int_status->tx_udf = (bool)i2s_ll_get_pcm_stat_lt2_tx3udf(i2s_cfg_index);
			int_status->rx_ovf = (bool)i2s_ll_get_pcm_stat_lt2_rx3ovf(i2s_cfg_index);
			int_status->tx_int = (bool)i2s_ll_get_pcm_stat_lt2_tx3int(i2s_cfg_index);
			int_status->rx_int = (bool)i2s_ll_get_pcm_stat_lt2_rx3int(i2s_cfg_index);
			break;
		default:
			break;
	}
...
bk_err_t i2s_hal_int_set(i2s_isr_id_t int_id, uint32_t value)
{
	switch (int_id) {
		...
		case I2S_ISR_CHL2_TXUDF:
			i2s_ll_set_pcm_cn_lt2_tx2udf_en(value, i2s_cfg_index);
			break;
		case I2S_ISR_CHL2_RXOVF:
			i2s_ll_set_pcm_cn_lt2_rx2ovf_en(value, i2s_cfg_index);
			break;
		case I2S_ISR_CHL2_TXINT:
			i2s_ll_set_pcm_cn_lt2_tx2int_en(value, i2s_cfg_index);
			break;
		case I2S_ISR_CHL2_RXINT:
			i2s_ll_set_pcm_cn_lt2_rx2int_en(value, i2s_cfg_index);
			break;

		case I2S_ISR_CHL3_TXUDF:
			i2s_ll_set_pcm_cn_lt2_tx3udf_en(value, i2s_cfg_index);
			break;
		case I2S_ISR_CHL3_RXOVF:
			i2s_ll_set_pcm_cn_lt2_rx3ovf_en(value, i2s_cfg_index);
			break;
		case I2S_ISR_CHL3_TXINT:
			i2s_ll_set_pcm_cn_lt2_tx3int_en(value, i2s_cfg_index);
			break;
		case I2S_ISR_CHL3_RXINT:
			i2s_ll_set_pcm_cn_lt2_rx3int_en(value, i2s_cfg_index);
			break;
...
bk_err_t i2s_hal_txudf_int_clear(i2s_channel_id_t channel_id)
{
	switch (channel_id) {
		...
		case I2S_CHANNEL_2:
			...
			break;
		case I2S_CHANNEL_3:
			i2s_ll_clear_pcm_stat_lt2_tx3udf(i2s_cfg_index);
			break;
		default:
			break;
	}
...
bk_err_t i2s_hal_rxovf_int_clear(i2s_channel_id_t channel_id)
{
	switch (channel_id) {
		...
		case I2S_CHANNEL_2:
			...
			break;
		case I2S_CHANNEL_3:
			i2s_ll_clear_pcm_stat_lt2_rx3ovf(i2s_cfg_index);
			break;
		default:
			break;
	}
...
bk_err_t i2s_hal_data_write(uint32_t channel_id, uint32_t value)
{
	switch (channel_id) {
		case I2S_CHANNEL_1:
			...
			break;
		case I2S_CHANNEL_2:
			i2s_ll_set_pcm_dat2_value(value, i2s_cfg_index);
			break;
		case I2S_CHANNEL_3:
			i2s_ll_set_pcm_dat3_value(value, i2s_cfg_index);
			break;
		default:
			break;
	}
