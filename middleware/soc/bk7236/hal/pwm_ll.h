...
static inline void pwm_ll_clr_pwm_sr_cc1if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc1if = 1;
}

/* REG_0x08:pwm_sr->CC2IF:0x8[1],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc2if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc2if = 1;
}

/* REG_0x08:pwm_sr->CC3IF:0x8[2],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc3if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc3if = 1;
}

/* REG_0x08:pwm_sr->CC4IF:0x8[3],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc4if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc4if = 1;
}

/* REG_0x08:pwm_sr->CC5IF:0x8[4],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc5if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc5if = 1;
}

/* REG_0x08:pwm_sr->CC6IF:0x8[5],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc6if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc6if = 1;
}

/* REG_0x08:pwm_sr->CC7IF:0x8[6],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc7if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc7if = 1;
}

/* REG_0x08:pwm_sr->CC8IF:0x8[7],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc8if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc8if = 1;
}

/* REG_0x08:pwm_sr->CC9IF:0x8[8],见CC1IF,0x0,W1C*/
static inline void pwm_ll_clr_pwm_sr_cc9if(pwm_hw_t *hw)
{
    hw->pwm_sr.cc9if = 1;
}
