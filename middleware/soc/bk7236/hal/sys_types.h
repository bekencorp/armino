...
#define LOW_POWER_DPLL_STABILITY_DELAY_TIME              (0.19)   // 0.19ms
...
typedef enum
{
	...
	POWER_MODULE_NAME_MEM0,
	POWER_MODULE_NAME_MEM4,
	POWER_MODULE_NAME_OFDM,
	POWER_MODULE_NAME_TCM0_PGEN,
	POWER_MODULE_NAME_ROM_PGEN,
	POWER_MODULE_NAME_TCM1_PGEN,
	POWER_MODULE_NAME_CPU1 ,
