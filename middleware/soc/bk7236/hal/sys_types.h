...
#define LOW_POWER_XTAL_DPLL_STABILITY_DELAY_TIME  ((LOW_POWER_XTAL_26M_STABILITY_DELAY_TIME+LOW_POWER_DPLL_STABILITY_DELAY_TIME)*1000)// 3000us
...
#define LOW_POWER_RESTORE_DELAY_TIME_HARDWARE            (0.8) //0.8ms
