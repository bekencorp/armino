...
#define efuse_ll_set_direction_write(hw)
#define efuse_ll_set_direction_read(hw)
#define efuse_ll_set_wr_data(hw, data)
#define efuse_ll_enable_vdd25(hw)
#define efuse_ll_disable_vdd25(hw)
