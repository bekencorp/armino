...
#define DMA_V_REQ_MUX_HSSPI          0x1
#define DMA_V_REQ_MUX_AUDIO          0x2
#define DMA_V_REQ_MUX_SDIO           0x3
#define DMA_V_REQ_MUX_UART1          0x4
#define DMA_V_REQ_MUX_UART2          0x5
#define DMA_V_REQ_MUX_I2S            0x6
#define DMA_V_REQ_MUX_GSPI0          0x7
#define DMA_V_REQ_MUX_JPEG           0x8
#define DMA_V_REQ_MUX_PSRAM_VIDEO    0x9
#define DMA_V_REQ_MUX_PSRAM_AUDIO    0xa
