    ...
    struct {
        ...
        union {
            struct {
                 ...
                 * 0x7: GSPI Rx Req
                 * 0x8: JPEG Write Req
                 * 0x9: PSRAM Video Read Req
                 * 0xa: PSRAM Audio Read Req
                 * 0xb~0xf: reserved
                 */
                 ...
                 * 0x7: GSPI Tx Req
                 * 0x8: reserved
                 * 0x9: PSRAM Video Write Req
                 * 0xa: PSRAM Audio Write Req
                 * 0xb~0xf: reserved
                 */
