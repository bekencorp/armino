...
typedef volatile struct {
	...
	}gpio_0_31_num[SOC_GPIO_0_31_NUM];
	...
	union {
		struct {
			...
			uint32_t auddpll_unlock_int_en:		1; /**< bit[1]: AUDDPLL Unlock int enable: 0:disable; 1:enable R/W */
			uint32_t dpll_unlock_int_flag:		1; /**< bit[2]: DPLL Unlock int flag:  R/W */
			uint32_t auddpll_unlock_int_flag:	1; /**< bit[3]: AUDDPLL Unlock int flag:  R/W */
			uint32_t usb_plugin_int_en:		1; /**< bit[4]: usb_plug_in_int_en: 0:disable; 1:enable R/W */
			uint32_t usb_plugout_int_en:		1; /**< bit[5]: usb_plug_out_int_en: 0:disable; 1:enable R/W */
			uint32_t usb_plugin_int_flag:		1; /**< bit[6]: usb_plugin_int_flag R/W */
			uint32_t usb_plugout_int_flag:		1; /**< bit[7]: usb_plugout_int_flag R/W */
	...
	union {
		struct {
			...
			uint32_t usb_plug_detect_flag:		1; /**< bit[1]: usb plug detect flag:R/W */
	...
	union {
		struct {
			uint32_t spi_mode:			2; /**< bit[0:1]: 0: gpio14-17 use for spi_dma mode; 1: gpio14-17 use for spi mode R/W */
									/**< 2: gpio30-33 use for spi_dma mode; 3: gpio30-33 use for spi mode R/W */
			uint32_t sdio_mode:			2; /**< bit[2:3]: 0: gpio14-19 use for sdio_dma mode; 1: gpio14-19 use for sdio host mode R/W */
									/**< 2: gpio34-39 use for sdio_dma mode; 3: gpio34-39 use for sdio host mode R/W */
	...
	union {
		struct {
			uint32_t gpio32_perial_mode:	2; /**< bit[0:1]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio33_perial_mode:	2; /**< bit[2:3]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio34_perial_mode:	2; /**< bit[4:5]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio35_perial_mode:	2; /**< bit[6:7]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio36_perial_mode:	2; /**< bit[8:9]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio37_perial_mode:	2; /**< bit[10:11]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio38_perial_mode:	2; /**< bit[12:13]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */
			uint32_t gpio39_perial_mode:	2; /**< bit[14:15]: 0:mode1; 1:mode2; 2:mode3; 3:mode4 R/W */

			uint32_t reserved:		16;

		};
		uint32_t v;
	} gpio_32_39_func_mode;
	...
	}gpio_32_39_num[SOC_GPIO_32_39_NUM];
