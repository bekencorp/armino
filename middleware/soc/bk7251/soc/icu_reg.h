...
#define ICU_V_PWMS_CLK_MUX_120M         2
...
#define ICU_FIQ_PSRAM				(31)
#define ICU_FIQ_BLE				(30)
#define ICU_FIQ_JPEG_ENCODER			(29)
#define ICU_FIQ_DPLL_UNLOCK			(28)
#define ICU_FIQ_SPI_DMA				(27)
#define ICU_FIQ_MAC_WAKEUP			(26)
#define ICU_FIQ_SECURITY			(25)
#define ICU_FIQ_USB_PLUG_INOUT			(24)
#define ICU_FIQ_SDIO_DMA			(23)
#define ICU_FIQ_MAC_GENERAL			(22)
#define ICU_FIQ_MAC_PROT_TRIGGER		(21)
#define ICU_FIQ_MAC_TX_TRIGGER			(20)
#define ICU_FIQ_MAC_RX_TRIGGER			(19)
#define ICU_FIQ_MAC_TX_RX_MISC			(18)
#define ICU_FIQ_MAC_TX_RX_TIMER			(17)
#define ICU_FIQ_MODEM				(16)

#define ICU_IRQ_GENERDMA			(15)
#define ICU_IRQ_FFT				(14)
#define ICU_IRQ_USB				(13)
#define ICU_IRQ_SDIO				(12)
#define ICU_IRQ_SARADC				(11)
#define ICU_IRQ_AUDIO				(10)
#define ICU_IRQ_PWM				(9)
#define ICU_IRQ_TIMER				(8)
#define ICU_IRQ_GPIO				(7)
#define ICU_IRQ_SPI				(6)
#define ICU_IRQ_I2C2				(5)
#define ICU_IRQ_I2S_PCM				(4)
#define ICU_IRQ_IRDA				(3)
#define ICU_IRQ_I2C1				(2)
#define ICU_IRQ_UART2				(1)
#define ICU_IRQ_UART1				(0)

#define ICU_PRI_FIQ_QSPI			(27)
#define ICU_PRI_FIQ_BLE                          (31)
#define ICU_PRI_FIQ_JPEG_DECODER                 (30)
...
#define ICU_PRI_FIQ_USB_PLUG_INOUT               (11)
#define ICU_PRI_FIQ_SDIO_DMA                     (8)
...
#define ICU_PRI_IRQ_FFT                          (13)
#define ICU_PRI_IRQ_USB                          (14)
#define ICU_PRI_IRQ_SDIO                         (15)
#define ICU_PRI_IRQ_SARADC                       (16)
#define ICU_PRI_IRQ_AUDIO                        (27)
