...
static inline uint32_t sdio_ll_get_reg0x0_value(void)
{
    return REG_READ(SDIO_REG0X0_ADDR);
}

static inline void sdio_ll_set_reg0x0_value(uint32_t value)
{
    REG_WRITE(SDIO_REG0X0_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0x0_sd_cmd_start(void)
{
    ...
    reg_value = ((reg_value >> SDIO_REG0X0_SD_CMD_START_POS) & SDIO_REG0X0_SD_CMD_START_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x0_sd_cmd_start(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value &= ~(SDIO_REG0X0_SD_CMD_START_MASK << SDIO_REG0X0_SD_CMD_START_POS);
    reg_value |= ((value & SDIO_REG0X0_SD_CMD_START_MASK) << SDIO_REG0X0_SD_CMD_START_POS);
    REG_WRITE(SDIO_REG0X0_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x0_sd_cmd_rsp(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X0_SD_CMD_RSP_POS) & SDIO_REG0X0_SD_CMD_RSP_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x0_sd_cmd_rsp(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value &= ~(SDIO_REG0X0_SD_CMD_RSP_MASK << SDIO_REG0X0_SD_CMD_RSP_POS);
    reg_value |= ((value & SDIO_REG0X0_SD_CMD_RSP_MASK) << SDIO_REG0X0_SD_CMD_RSP_POS);
    REG_WRITE(SDIO_REG0X0_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x0_sd_cmd_long(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X0_SD_CMD_LONG_POS) & SDIO_REG0X0_SD_CMD_LONG_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x0_sd_cmd_long(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value &= ~(SDIO_REG0X0_SD_CMD_LONG_MASK << SDIO_REG0X0_SD_CMD_LONG_POS);
    reg_value |= ((value & SDIO_REG0X0_SD_CMD_LONG_MASK) << SDIO_REG0X0_SD_CMD_LONG_POS);
    REG_WRITE(SDIO_REG0X0_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x0_sd_cmd_crc_check(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X0_SD_CMD_CRC_CHECK_POS) & SDIO_REG0X0_SD_CMD_CRC_CHECK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x0_sd_cmd_crc_check(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value &= ~(SDIO_REG0X0_SD_CMD_CRC_CHECK_MASK << SDIO_REG0X0_SD_CMD_CRC_CHECK_POS);
    reg_value |= ((value & SDIO_REG0X0_SD_CMD_CRC_CHECK_MASK) << SDIO_REG0X0_SD_CMD_CRC_CHECK_POS);
    REG_WRITE(SDIO_REG0X0_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x0_cmd_index(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X0_CMD_INDEX_POS) & SDIO_REG0X0_CMD_INDEX_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x0_cmd_index(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X0_ADDR);
    reg_value &= ~(SDIO_REG0X0_CMD_INDEX_MASK << SDIO_REG0X0_CMD_INDEX_POS);
    reg_value |= ((value & SDIO_REG0X0_CMD_INDEX_MASK) << SDIO_REG0X0_CMD_INDEX_POS);
    REG_WRITE(SDIO_REG0X0_ADDR,reg_value);
}

static inline uint32_t sdio_ll_get_reg0x1_value(void)
{
    return REG_READ(SDIO_REG0X1_ADDR);
}

static inline void sdio_ll_set_reg0x1_value(uint32_t value)
{
...
static inline uint32_t sdio_ll_get_reg0x2_value(void)
{
    return REG_READ(SDIO_REG0X2_ADDR);
}

static inline void sdio_ll_set_reg0x2_value(uint32_t value)
{
...
static inline uint32_t sdio_ll_get_reg0x3_value(void)
{
    return REG_READ(SDIO_REG0X3_ADDR);
}

static inline void sdio_ll_set_reg0x3_value(uint32_t value)
{
    REG_WRITE(SDIO_REG0X3_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_data_en(void)
{
    ...
    reg_value = ((reg_value >> SDIO_REG0X3_SD_DATA_EN_POS) & SDIO_REG0X3_SD_DATA_EN_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_data_en(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_DATA_EN_MASK << SDIO_REG0X3_SD_DATA_EN_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_DATA_EN_MASK) << SDIO_REG0X3_SD_DATA_EN_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_data_stop_en(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X3_SD_DATA_STOP_EN_POS) & SDIO_REG0X3_SD_DATA_STOP_EN_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_data_stop_en(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_DATA_STOP_EN_MASK << SDIO_REG0X3_SD_DATA_STOP_EN_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_DATA_STOP_EN_MASK) << SDIO_REG0X3_SD_DATA_STOP_EN_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_data_bus(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X3_SD_DATA_BUS_POS) & SDIO_REG0X3_SD_DATA_BUS_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_data_bus(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_DATA_BUS_MASK << SDIO_REG0X3_SD_DATA_BUS_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_DATA_BUS_MASK) << SDIO_REG0X3_SD_DATA_BUS_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_data_mul_blk(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X3_SD_DATA_MUL_BLK_POS) & SDIO_REG0X3_SD_DATA_MUL_BLK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_data_mul_blk(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_DATA_MUL_BLK_MASK << SDIO_REG0X3_SD_DATA_MUL_BLK_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_DATA_MUL_BLK_MASK) << SDIO_REG0X3_SD_DATA_MUL_BLK_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_data_blk_size(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X3_SD_DATA_BLK_SIZE_POS) & SDIO_REG0X3_SD_DATA_BLK_SIZE_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_data_blk_size(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_DATA_BLK_SIZE_MASK << SDIO_REG0X3_SD_DATA_BLK_SIZE_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_DATA_BLK_SIZE_MASK) << SDIO_REG0X3_SD_DATA_BLK_SIZE_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_start_wr_en(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X3_SD_START_WR_EN_POS) & SDIO_REG0X3_SD_START_WR_EN_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_start_wr_en(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_START_WR_EN_MASK << SDIO_REG0X3_SD_START_WR_EN_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_START_WR_EN_MASK) << SDIO_REG0X3_SD_START_WR_EN_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x3_sd_byte_sel(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X3_SD_BYTE_SEL_POS) & SDIO_REG0X3_SD_BYTE_SEL_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x3_sd_byte_sel(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X3_ADDR);
    reg_value &= ~(SDIO_REG0X3_SD_BYTE_SEL_MASK << SDIO_REG0X3_SD_BYTE_SEL_POS);
    reg_value |= ((value & SDIO_REG0X3_SD_BYTE_SEL_MASK) << SDIO_REG0X3_SD_BYTE_SEL_POS);
    REG_WRITE(SDIO_REG0X3_ADDR,reg_value);
}
...
static inline void sdio_ll_set_reg0x9_value(uint32_t value)
{
    REG_WRITE(SDIO_REG0X9_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_cmd_send_norsp_end_int(void)
{
    ...
    reg_value = ((reg_value >> SDIO_REG0X9_SD_CMD_SEND_NORSP_END_INT_POS) & SDIO_REG0X9_SD_CMD_SEND_NORSP_END_INT_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x9_sd_cmd_send_norsp_end_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value &= ~(SDIO_REG0X9_SD_CMD_SEND_NORSP_END_INT_MASK << SDIO_REG0X9_SD_CMD_SEND_NORSP_END_INT_POS);
    reg_value |= ((value & SDIO_REG0X9_SD_CMD_SEND_NORSP_END_INT_MASK) << SDIO_REG0X9_SD_CMD_SEND_NORSP_END_INT_POS);
...
static inline uint32_t sdio_ll_get_reg0x9_sd_cmd_send_rsp_end_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_CMD_SEND_RSP_END_INT_POS) & SDIO_REG0X9_SD_CMD_SEND_RSP_END_INT_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x9_sd_cmd_send_rsp_end_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value &= ~(SDIO_REG0X9_SD_CMD_SEND_RSP_END_INT_MASK << SDIO_REG0X9_SD_CMD_SEND_RSP_END_INT_POS);
    reg_value |= ((value & SDIO_REG0X9_SD_CMD_SEND_RSP_END_INT_MASK) << SDIO_REG0X9_SD_CMD_SEND_RSP_END_INT_POS);
    REG_WRITE(SDIO_REG0X9_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_cmd_send_rsp_timeout_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_CMD_SEND_RSP_TIMEOUT_INT_POS) & SDIO_REG0X9_SD_CMD_SEND_RSP_TIMEOUT_INT_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x9_sd_cmd_send_rsp_timeout_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value &= ~(SDIO_REG0X9_SD_CMD_SEND_RSP_TIMEOUT_INT_MASK << SDIO_REG0X9_SD_CMD_SEND_RSP_TIMEOUT_INT_POS);
    reg_value |= ((value & SDIO_REG0X9_SD_CMD_SEND_RSP_TIMEOUT_INT_MASK) << SDIO_REG0X9_SD_CMD_SEND_RSP_TIMEOUT_INT_POS);
    REG_WRITE(SDIO_REG0X9_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_data_rec_end_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_DATA_REC_END_INT_POS) & SDIO_REG0X9_SD_DATA_REC_END_INT_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x9_sd_data_rec_end_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value &= ~(SDIO_REG0X9_SD_DATA_REC_END_INT_MASK << SDIO_REG0X9_SD_DATA_REC_END_INT_POS);
    reg_value |= ((value & SDIO_REG0X9_SD_DATA_REC_END_INT_MASK) << SDIO_REG0X9_SD_DATA_REC_END_INT_POS);
    REG_WRITE(SDIO_REG0X9_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_data_wr_end_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_DATA_WR_END_INT_POS) & SDIO_REG0X9_SD_DATA_WR_END_INT_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_data_time_out_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_DATA_TIME_OUT_INT_POS) & SDIO_REG0X9_SD_DATA_TIME_OUT_INT_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x9_sd_data_time_out_int(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value &= ~(SDIO_REG0X9_SD_DATA_TIME_OUT_INT_MASK << SDIO_REG0X9_SD_DATA_TIME_OUT_INT_POS);
    reg_value |= ((value & SDIO_REG0X9_SD_DATA_TIME_OUT_INT_MASK) << SDIO_REG0X9_SD_DATA_TIME_OUT_INT_POS);
    REG_WRITE(SDIO_REG0X9_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x9_rx_fifo_need_read(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_RX_FIFO_NEED_READ_POS)&SDIO_REG0X9_RX_FIFO_NEED_READ_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_tx_fifo_need_write(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_TX_FIFO_NEED_WRITE_POS)&SDIO_REG0X9_TX_FIFO_NEED_WRITE_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_rx_ov(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_RX_OV_POS) & SDIO_REG0X9_RX_OV_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x9_rx_ov(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value &= ~(SDIO_REG0X9_RX_OV_MASK << SDIO_REG0X9_RX_OV_POS);
    reg_value |= ((value & SDIO_REG0X9_RX_OV_MASK) << SDIO_REG0X9_RX_OV_POS);
    REG_WRITE(SDIO_REG0X9_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_rsp_cmd_crc_ok(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_RSP_CMD_CRC_OK_POS)&SDIO_REG0X9_SD_RSP_CMD_CRC_OK_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_rsp_cmd_crc_fail(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_RSP_CMD_CRC_FAIL_POS)&SDIO_REG0X9_SD_RSP_CMD_CRC_FAIL_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_data_crc_ok(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_DATA_CRC_OK_POS)&SDIO_REG0X9_SD_DATA_CRC_OK_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_data_crc_fail(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_DATA_CRC_FAIL_POS)&SDIO_REG0X9_SD_DATA_CRC_FAIL_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_sd_rsp_index(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_SD_RSP_INDEX_POS)&SDIO_REG0X9_SD_RSP_INDEX_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_wr_status(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_WR_STATUS_POS)&SDIO_REG0X9_WR_STATUS_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_data_busy(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_DATA_BUSY_POS)&SDIO_REG0X9_DATA_BUSY_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_cmd_s_res_end_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_CMD_S_RES_END_INT_POS) & SDIO_REG0X9_CMD_S_RES_END_INT_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_dat_s_wr_wai_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_DAT_S_WR_WAI_INT_POS) & SDIO_REG0X9_DAT_S_WR_WAI_INT_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0x9_dat_s_rd_bus_int(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X9_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X9_DAT_S_RD_BUS_INT_POS) & SDIO_REG0X9_DAT_S_RD_BUS_INT_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_value(uint32_t value)
{
    REG_WRITE(SDIO_REG0XA_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_sd_cmd_send_norsp_end_mask(void)
{
    ...
    reg_value = ((reg_value >> SDIO_REG0XA_SD_CMD_SEND_NORSP_END_MASK_POS) & SDIO_REG0XA_SD_CMD_SEND_NORSP_END_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_sd_cmd_send_norsp_end_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_SD_CMD_SEND_NORSP_END_MASK_MASK << SDIO_REG0XA_SD_CMD_SEND_NORSP_END_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_SD_CMD_SEND_NORSP_END_MASK_MASK) << SDIO_REG0XA_SD_CMD_SEND_NORSP_END_MASK_POS);
...
static inline uint32_t sdio_ll_get_reg0xa_sd_cmd_send_rsp_end_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_SD_CMD_SEND_RSP_END_MASK_POS) & SDIO_REG0XA_SD_CMD_SEND_RSP_END_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_sd_cmd_send_rsp_end_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_SD_CMD_SEND_RSP_END_MASK_MASK << SDIO_REG0XA_SD_CMD_SEND_RSP_END_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_SD_CMD_SEND_RSP_END_MASK_MASK) << SDIO_REG0XA_SD_CMD_SEND_RSP_END_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_sd_cmd_send_rsp_timeout_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_SD_CMD_SEND_RSP_TIMEOUT_MASK_POS) & SDIO_REG0XA_SD_CMD_SEND_RSP_TIMEOUT_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_sd_cmd_send_rsp_timeout_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_SD_CMD_SEND_RSP_TIMEOUT_MASK_MASK << SDIO_REG0XA_SD_CMD_SEND_RSP_TIMEOUT_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_SD_CMD_SEND_RSP_TIMEOUT_MASK_MASK) << SDIO_REG0XA_SD_CMD_SEND_RSP_TIMEOUT_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_sd_data_rec_end_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_SD_DATA_REC_END_MASK_POS) & SDIO_REG0XA_SD_DATA_REC_END_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_sd_data_rec_end_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_SD_DATA_REC_END_MASK_MASK << SDIO_REG0XA_SD_DATA_REC_END_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_SD_DATA_REC_END_MASK_MASK) << SDIO_REG0XA_SD_DATA_REC_END_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_sd_data_wr_end_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_SD_DATA_WR_END_MASK_POS) & SDIO_REG0XA_SD_DATA_WR_END_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_sd_data_wr_end_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_SD_DATA_WR_END_MASK_MASK << SDIO_REG0XA_SD_DATA_WR_END_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_SD_DATA_WR_END_MASK_MASK) << SDIO_REG0XA_SD_DATA_WR_END_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_sd_data_time_out_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_SD_DATA_TIME_OUT_MASK_POS) & SDIO_REG0XA_SD_DATA_TIME_OUT_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_sd_data_time_out_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_SD_DATA_TIME_OUT_MASK_MASK << SDIO_REG0XA_SD_DATA_TIME_OUT_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_SD_DATA_TIME_OUT_MASK_MASK) << SDIO_REG0XA_SD_DATA_TIME_OUT_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_rx_fifo_need_read_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_RX_FIFO_NEED_READ_MASK_POS) & SDIO_REG0XA_RX_FIFO_NEED_READ_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_rx_fifo_need_read_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_RX_FIFO_NEED_READ_MASK_MASK << SDIO_REG0XA_RX_FIFO_NEED_READ_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_RX_FIFO_NEED_READ_MASK_MASK) << SDIO_REG0XA_RX_FIFO_NEED_READ_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_tx_fifo_need_write_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_TX_FIFO_NEED_WRITE_MASK_POS) & SDIO_REG0XA_TX_FIFO_NEED_WRITE_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_tx_fifo_need_write_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_TX_FIFO_NEED_WRITE_MASK_MASK << SDIO_REG0XA_TX_FIFO_NEED_WRITE_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_TX_FIFO_NEED_WRITE_MASK_MASK) << SDIO_REG0XA_TX_FIFO_NEED_WRITE_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_rx_ov_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_RX_OV_MASK_POS) & SDIO_REG0XA_RX_OV_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_rx_ov_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_RX_OV_MASK_MASK << SDIO_REG0XA_RX_OV_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_RX_OV_MASK_MASK) << SDIO_REG0XA_RX_OV_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_tx_fifo_empt_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_TX_FIFO_EMPT_MASK_POS) & SDIO_REG0XA_TX_FIFO_EMPT_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_tx_fifo_empt_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_TX_FIFO_EMPT_MASK_MASK << SDIO_REG0XA_TX_FIFO_EMPT_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_TX_FIFO_EMPT_MASK_MASK) << SDIO_REG0XA_TX_FIFO_EMPT_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_cmd_s_res_end_int_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_CMD_S_RES_END_INT_MASK_POS) & SDIO_REG0XA_CMD_S_RES_END_INT_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_cmd_s_res_end_int_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_CMD_S_RES_END_INT_MASK_MASK << SDIO_REG0XA_CMD_S_RES_END_INT_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_CMD_S_RES_END_INT_MASK_MASK) << SDIO_REG0XA_CMD_S_RES_END_INT_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_dat_s_wr_wai_int_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_DAT_S_WR_WAI_INT_MASK_POS) & SDIO_REG0XA_DAT_S_WR_WAI_INT_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_dat_s_wr_wai_int_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_DAT_S_WR_WAI_INT_MASK_MASK << SDIO_REG0XA_DAT_S_WR_WAI_INT_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_DAT_S_WR_WAI_INT_MASK_MASK) << SDIO_REG0XA_DAT_S_WR_WAI_INT_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xa_dat_s_rd_bus_int_mask(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XA_DAT_S_RD_BUS_INT_MASK_POS) & SDIO_REG0XA_DAT_S_RD_BUS_INT_MASK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xa_dat_s_rd_bus_int_mask(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XA_ADDR);
    reg_value &= ~(SDIO_REG0XA_DAT_S_RD_BUS_INT_MASK_MASK << SDIO_REG0XA_DAT_S_RD_BUS_INT_MASK_POS);
    reg_value |= ((value & SDIO_REG0XA_DAT_S_RD_BUS_INT_MASK_MASK) << SDIO_REG0XA_DAT_S_RD_BUS_INT_MASK_POS);
    REG_WRITE(SDIO_REG0XA_ADDR,reg_value);
}
...
{
    REG_WRITE(SDIO_REG0XB_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0xd_rx_fifo_threshold(void)
{
    ...
    reg_value = ((reg_value >> SDIO_REG0XD_RX_FIFO_THRESHOLD_POS) & SDIO_REG0XD_RX_FIFO_THRESHOLD_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xd_rx_fifo_threshold(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value &= ~(SDIO_REG0XD_RX_FIFO_THRESHOLD_MASK << SDIO_REG0XD_RX_FIFO_THRESHOLD_POS);
    reg_value |= ((value & SDIO_REG0XD_RX_FIFO_THRESHOLD_MASK) << SDIO_REG0XD_RX_FIFO_THRESHOLD_POS);
...
static inline uint32_t sdio_ll_get_reg0xd_tx_fifo_threshold(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_TX_FIFO_THRESHOLD_POS) & SDIO_REG0XD_TX_FIFO_THRESHOLD_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xd_tx_fifo_threshold(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value &= ~(SDIO_REG0XD_TX_FIFO_THRESHOLD_MASK << SDIO_REG0XD_TX_FIFO_THRESHOLD_POS);
    reg_value |= ((value & SDIO_REG0XD_TX_FIFO_THRESHOLD_MASK) << SDIO_REG0XD_TX_FIFO_THRESHOLD_POS);
    REG_WRITE(SDIO_REG0XD_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xd_rx_fifo_rst(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_RX_FIFO_RST_POS) & SDIO_REG0XD_RX_FIFO_RST_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0xd_tx_fifo_rst(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_TX_FIFO_RST_POS) & SDIO_REG0XD_TX_FIFO_RST_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0xd_rxfifo_rd_ready(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_RXFIFO_RD_READY_POS)&SDIO_REG0XD_RXFIFO_RD_READY_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0xd_txfifo_wr_ready(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_TXFIFO_WR_READY_POS)&SDIO_REG0XD_TXFIFO_WR_READY_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0xd_sd_sta_rst(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_SD_STA_RST_POS) & SDIO_REG0XD_SD_STA_RST_MASK);
    return reg_value;
}
...
static inline uint32_t sdio_ll_get_reg0xd_sd_clk_sel(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_SD_CLK_SEL_POS) & SDIO_REG0XD_SD_CLK_SEL_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xd_sd_clk_sel(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value &= ~(SDIO_REG0XD_SD_CLK_SEL_MASK << SDIO_REG0XD_SD_CLK_SEL_POS);
    reg_value |= ((value & SDIO_REG0XD_SD_CLK_SEL_MASK) << SDIO_REG0XD_SD_CLK_SEL_POS);
    REG_WRITE(SDIO_REG0XD_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xd_sd_rd_wait_sel(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_SD_RD_WAIT_SEL_POS) & SDIO_REG0XD_SD_RD_WAIT_SEL_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xd_sd_rd_wait_sel(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value &= ~(SDIO_REG0XD_SD_RD_WAIT_SEL_MASK << SDIO_REG0XD_SD_RD_WAIT_SEL_POS);
    reg_value |= ((value & SDIO_REG0XD_SD_RD_WAIT_SEL_MASK) << SDIO_REG0XD_SD_RD_WAIT_SEL_POS);
    REG_WRITE(SDIO_REG0XD_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xd_sd_wr_wait_sel(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_SD_WR_WAIT_SEL_POS) & SDIO_REG0XD_SD_WR_WAIT_SEL_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xd_sd_wr_wait_sel(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value &= ~(SDIO_REG0XD_SD_WR_WAIT_SEL_MASK << SDIO_REG0XD_SD_WR_WAIT_SEL_POS);
    reg_value |= ((value & SDIO_REG0XD_SD_WR_WAIT_SEL_MASK) << SDIO_REG0XD_SD_WR_WAIT_SEL_POS);
    REG_WRITE(SDIO_REG0XD_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0xd_clk_rec_sel(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value = ((reg_value >> SDIO_REG0XD_CLK_REC_SEL_POS) & SDIO_REG0XD_CLK_REC_SEL_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0xd_clk_rec_sel(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0XD_ADDR);
    reg_value &= ~(SDIO_REG0XD_CLK_REC_SEL_MASK << SDIO_REG0XD_CLK_REC_SEL_POS);
    reg_value |= ((value & SDIO_REG0XD_CLK_REC_SEL_MASK) << SDIO_REG0XD_CLK_REC_SEL_POS);
    REG_WRITE(SDIO_REG0XD_ADDR,reg_value);
}
...
static inline void sdio_ll_set_reg0x10_value(uint32_t value)
{
    REG_WRITE(SDIO_REG0X10_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0x10_sd_slave(void)
{
    ...
    reg_value = ((reg_value >> SDIO_REG0X10_SD_SLAVE_POS) & SDIO_REG0X10_SD_SLAVE_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x10_sd_slave(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X10_ADDR);
    reg_value &= ~(SDIO_REG0X10_SD_SLAVE_MASK << SDIO_REG0X10_SD_SLAVE_POS);
    reg_value |= ((value & SDIO_REG0X10_SD_SLAVE_MASK) << SDIO_REG0X10_SD_SLAVE_POS);
...
static inline uint32_t sdio_ll_get_reg0x10_dat_s_rd_mul_blk(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X10_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X10_DAT_S_RD_MUL_BLK_POS) & SDIO_REG0X10_DAT_S_RD_MUL_BLK_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x10_dat_s_rd_mul_blk(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X10_ADDR);
    reg_value &= ~(SDIO_REG0X10_DAT_S_RD_MUL_BLK_MASK << SDIO_REG0X10_DAT_S_RD_MUL_BLK_POS);
    reg_value |= ((value & SDIO_REG0X10_DAT_S_RD_MUL_BLK_MASK) << SDIO_REG0X10_DAT_S_RD_MUL_BLK_POS);
    REG_WRITE(SDIO_REG0X10_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x10_io_cur_sta_reg(void)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X10_ADDR);
    reg_value = ((reg_value >> SDIO_REG0X10_IO_CUR_STA_REG_POS) & SDIO_REG0X10_IO_CUR_STA_REG_MASK);
    return reg_value;
}
...
static inline void sdio_ll_set_reg0x10_io_cur_sta_reg(uint32_t value)
{
    uint32_t reg_value;
    reg_value = REG_READ(SDIO_REG0X10_ADDR);
    reg_value &= ~(SDIO_REG0X10_IO_CUR_STA_REG_MASK << SDIO_REG0X10_IO_CUR_STA_REG_POS);
    reg_value |= ((value & SDIO_REG0X10_IO_CUR_STA_REG_MASK) << SDIO_REG0X10_IO_CUR_STA_REG_POS);
    REG_WRITE(SDIO_REG0X10_ADDR,reg_value);
}
...
static inline uint32_t sdio_ll_get_reg0x11_sd_slave_rdat_0(void)
{
    return REG_READ(SDIO_REG0X11_ADDR);
}

static inline void sdio_ll_set_reg0x11_sd_slave_rdat_0(uint32_t value)
{
    REG_WRITE(SDIO_REG0X11_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0x12_sd_slave_rdat_1(void)
{
    return REG_READ(SDIO_REG0X12_ADDR);
}

static inline void sdio_ll_set_reg0x12_sd_slave_rdat_1(uint32_t value)
{
    REG_WRITE(SDIO_REG0X12_ADDR,value);
}
...
static inline uint32_t sdio_ll_get_reg0x13_sd_slave_wdat_0(void)
{
    return REG_READ(SDIO_REG0X13_ADDR);
}
...
static inline uint32_t sdio_ll_get_reg0x14_sd_slave_wdat_1(void)
{
    return REG_READ(SDIO_REG0X14_ADDR);
}
