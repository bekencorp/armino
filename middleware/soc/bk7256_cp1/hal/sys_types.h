...
#define WIFI_MODEM_RC_EN               (1 << SYS_CPU1INT_0_31_EN_CPU1_WIFI_INT_PHY_RIU_EN_POS)
...
#define WIFI_MAC_PORT_TRIGGER_INT_BIT  (1 << SYS_CPU1_INT_32_63_EN_CPU1_WIFI_MAC_PORT_TRIGGER_EN_POS)
