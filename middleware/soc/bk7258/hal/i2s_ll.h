...
#endif
#ifndef I2S1_LL_REG_BASE
#define I2S1_LL_REG_BASE  SOC_I2S1_REG_BASE
#endif
#ifndef I2S2_LL_REG_BASE
#define I2S2_LL_REG_BASE  SOC_I2S2_REG_BASE
#endif
...
static inline uint32_t i2s_ll_get_dev_addr_by_idx(i2s_channel_idx idx) {
	...
	} else if (idx == I2S_CHANN_1) {
		addr = I2S1_LL_REG_BASE;
	} else if (idx == I2S_CHANN_2) {
		addr = I2S2_LL_REG_BASE;
	} else {
		addr = 0;
	}
...
static inline void i2s_ll_set_pcm_cn_lt2_value(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->v = v;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_value(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->v;
}

static inline void i2s_ll_set_pcm_cn_lt2_rx2int_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->rx2int_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_rx2int_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->rx2int_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_tx2int_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->tx2int_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_tx2int_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->tx2int_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_rx2ovf_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->rx2ovf_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_rx2ovf_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->rx2ovf_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_tx2udf_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->tx2udf_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_tx2udf_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->tx2udf_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_rx3int_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->rx3int_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_rx3int_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->rx3int_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_tx3int_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->tx3nt_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_tx3int_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->tx3nt_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_rx3ovf_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->rx3ovf_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_rx3ovf_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->rx3ovf_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_tx3udf_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->tx3udf_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_tx3udf_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->tx3udf_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_rx4int_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->rx4int_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_rx4int_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->rx4int_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_tx4int_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->tx4nt_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_tx4int_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->tx4nt_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_rx4ovf_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->rx4ovf_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_rx4ovf_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->rx4ovf_en & 0x1;
}

static inline void i2s_ll_set_pcm_cn_lt2_tx4udf_en(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	r->tx4udf_en = v & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_cn_lt2_tx4udf_en(i2s_channel_idx idx) {
	i2s_pcm_cn_lt2_t *r = (i2s_pcm_cn_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x8 << 2));
	return r->tx4udf_en & 0x1;
}

//reg :

static inline void i2s_ll_set_pcm_stat_lt2_value(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = v;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_value(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->v;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_rx2int(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->rx2int & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_tx2int(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->tx2int & 0x1;
}

static inline void i2s_ll_clear_pcm_stat_lt2_rx2ovf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = (I2S_RX2OVF_MASK <<I2S_RX2OVF_POS);
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_rx2ovf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->rx2ovf & 0x1;
}

static inline void i2s_ll_clear_pcm_stat_lt2_tx2udf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = (I2S_TX2UDF_MASK << I2S_TX2UDF_POS);
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_tx2udf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->tx2udf & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_rx3int(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->rx3int & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_tx3int(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->tx3int & 0x1;
}

static inline void i2s_ll_clear_pcm_stat_lt2_rx3ovf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = (I2S_RX3OVF_MASK << I2S_RX3OVF_POS);
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_rx3ovf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->rx3ovf & 0x1;
}

static inline void i2s_ll_clear_pcm_stat_lt2_tx3udf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = (I2S_TX3UDF_MASK << I2S_TX3UDF_POS);
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_tx3udf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->tx3udf & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_rx4int(i2s_channel_idx idx){
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->rx4int & 0x1;
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_tx4int(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->tx4int & 0x1;
}

static inline void i2s_ll_clear_pcm_stat_lt2_rx4ovf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = (I2S_RX4OVF_MASK << I2S_RX4OVF_POS);
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_rx4ovf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->rx4ovf & 0x1;
}

static inline void i2s_ll_clear_pcm_stat_lt2_tx4udf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	r->v = (I2S_TX4UDF_MASK << I2S_TX4UDF_POS);
}

static inline uint32_t i2s_ll_get_pcm_stat_lt2_tx4udf(i2s_channel_idx idx) {
	i2s_pcm_stat_lt2_t *r = (i2s_pcm_stat_lt2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0x9 << 2));
	return r->tx4udf & 0x1;
}
//reg :

static inline void i2s_ll_set_pcm_dat2_value(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_dat2_t *r = (i2s_pcm_dat2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xa << 2));
	r->v = v;
}

static inline uint32_t i2s_ll_get_pcm_dat2_value(i2s_channel_idx idx) {
	i2s_pcm_dat2_t *r = (i2s_pcm_dat2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xa << 2));
	return r->v;
}

static inline uint32_t i2s_ll_get_pcm_dat2_i2s_dat2(i2s_channel_idx idx) {
	i2s_pcm_dat2_t *r = (i2s_pcm_dat2_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xa << 2));
	return r->i2s_dat2;
}
...
static inline void i2s_ll_set_pcm_dat3_value(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_dat3_t *r = (i2s_pcm_dat3_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xb << 2));
	r->v = v;
}

static inline uint32_t i2s_ll_get_pcm_dat3_value(i2s_channel_idx idx) {
	i2s_pcm_dat3_t *r = (i2s_pcm_dat3_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xb << 2));
	return r->v;
}

static inline uint32_t i2s_ll_get_pcm_dat3_i2s_dat3(i2s_channel_idx idx) {
	i2s_pcm_dat3_t *r = (i2s_pcm_dat3_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xb << 2));
	return r->i2s_dat3;
}
...
static inline void i2s_ll_set_pcm_dat4_value(uint32_t v, i2s_channel_idx idx) {
	i2s_pcm_dat4_t *r = (i2s_pcm_dat4_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xc << 2));
	r->v = v;
}

static inline uint32_t i2s_ll_get_pcm_dat4_value(i2s_channel_idx idx) {
	i2s_pcm_dat4_t *r = (i2s_pcm_dat4_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xc << 2));
	return r->v;
}

static inline uint32_t i2s_ll_get_pcm_dat4_i2s_dat4(i2s_channel_idx idx) {
	i2s_pcm_dat4_t *r = (i2s_pcm_dat4_t*)(i2s_ll_get_dev_addr_by_idx(idx) + (0xc << 2));
	return r->i2s_dat4;
}
#ifdef __cplusplus
