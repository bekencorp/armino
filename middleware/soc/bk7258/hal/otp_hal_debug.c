...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	rolck_cde_000: %8x\r\n", r->rolck_cde_000);
	SOC_LOGI("	rolck_cde_001: %8x\r\n", r->rolck_cde_001);
	SOC_LOGI("	rolck_cde_002: %8x\r\n", r->rolck_cde_002);
	SOC_LOGI("	rolck_cde_003: %8x\r\n", r->rolck_cde_003);
	SOC_LOGI("	rolck_cde_004: %8x\r\n", r->rolck_cde_004);
	SOC_LOGI("	rolck_cde_005: %8x\r\n", r->rolck_cde_005);
	SOC_LOGI("	rolck_cde_006: %8x\r\n", r->rolck_cde_006);
	SOC_LOGI("	rolck_cde_007: %8x\r\n", r->rolck_cde_007);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	rolck_cde_008: %8x\r\n", r->rolck_cde_008);
	SOC_LOGI("	rolck_cde_009: %8x\r\n", r->rolck_cde_009);
	SOC_LOGI("	rolck_cde_010: %8x\r\n", r->rolck_cde_010);
	SOC_LOGI("	rolck_cde_011: %8x\r\n", r->rolck_cde_011);
	SOC_LOGI("	rolck_cde_012: %8x\r\n", r->rolck_cde_012);
	SOC_LOGI("	rolck_cde_013: %8x\r\n", r->rolck_cde_013);
	SOC_LOGI("	rolck_cde_014: %8x\r\n", r->rolck_cde_014);
	SOC_LOGI("	rolck_cde_015: %8x\r\n", r->rolck_cde_015);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	rolck_cde_016: %8x\r\n", r->rolck_cde_016);
	SOC_LOGI("	rolck_cde_017: %8x\r\n", r->rolck_cde_017);
	SOC_LOGI("	rolck_cde_018: %8x\r\n", r->rolck_cde_018);
	SOC_LOGI("	rolck_cde_019: %8x\r\n", r->rolck_cde_019);
	SOC_LOGI("	rolck_cde_020: %8x\r\n", r->rolck_cde_020);
	SOC_LOGI("	rolck_cde_021: %8x\r\n", r->rolck_cde_021);
	SOC_LOGI("	rolck_cde_022: %8x\r\n", r->rolck_cde_022);
	SOC_LOGI("	rolck_cde_023: %8x\r\n", r->rolck_cde_023);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	secr_ctl_otp_0: %8x\r\n", r->secr_ctl_otp_0);
	SOC_LOGI("	secr_ctl_otp_1: %8x\r\n", r->secr_ctl_otp_1);
	SOC_LOGI("	secr_ctl_otp_2: %8x\r\n", r->secr_ctl_otp_2);
	SOC_LOGI("	secr_ctl_otp_3: %8x\r\n", r->secr_ctl_otp_3);
	SOC_LOGI("	secr_ctl_puf_0: %8x\r\n", r->secr_ctl_puf_0);
	SOC_LOGI("	secr_ctl_puf_1: %8x\r\n", r->secr_ctl_puf_1);
	SOC_LOGI("	secr_ctl_puf_2: %8x\r\n", r->secr_ctl_puf_2);
	SOC_LOGI("	secr_ctl_puf_3: %8x\r\n", r->secr_ctl_puf_3);
	SOC_LOGI("	secr_zeroize: %8x\r\n", r->secr_zeroize);
	SOC_LOGI("	reserved_27_27: %8x\r\n", r->reserved_27_27);
	SOC_LOGI("	secr_prot_en: %8x\r\n", r->secr_prot_en);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_lckwd_000: %8x\r\n", r->puf_lckwd_000);
	SOC_LOGI("	puf_lckwd_001: %8x\r\n", r->puf_lckwd_001);
	SOC_LOGI("	puf_lckwd_002: %8x\r\n", r->puf_lckwd_002);
	SOC_LOGI("	puf_lckwd_003: %8x\r\n", r->puf_lckwd_003);
	SOC_LOGI("	puf_lckwd_004: %8x\r\n", r->puf_lckwd_004);
	SOC_LOGI("	puf_lckwd_005: %8x\r\n", r->puf_lckwd_005);
	SOC_LOGI("	puf_lckwd_006: %8x\r\n", r->puf_lckwd_006);
	SOC_LOGI("	puf_lckwd_007: %8x\r\n", r->puf_lckwd_007);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_lckwd_008: %8x\r\n", r->puf_lckwd_008);
	SOC_LOGI("	puf_lckwd_009: %8x\r\n", r->puf_lckwd_009);
	SOC_LOGI("	puf_lckwd_010: %8x\r\n", r->puf_lckwd_010);
	SOC_LOGI("	puf_lckwd_011: %8x\r\n", r->puf_lckwd_011);
	SOC_LOGI("	puf_lckwd_012: %8x\r\n", r->puf_lckwd_012);
	SOC_LOGI("	puf_lckwd_013: %8x\r\n", r->puf_lckwd_013);
	SOC_LOGI("	puf_lckwd_014: %8x\r\n", r->puf_lckwd_014);
	SOC_LOGI("	puf_lckwd_015: %8x\r\n", r->puf_lckwd_015);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_lckwd_016: %8x\r\n", r->puf_lckwd_016);
	SOC_LOGI("	puf_lckwd_017: %8x\r\n", r->puf_lckwd_017);
	SOC_LOGI("	puf_lckwd_018: %8x\r\n", r->puf_lckwd_018);
	SOC_LOGI("	puf_lckwd_019: %8x\r\n", r->puf_lckwd_019);
	SOC_LOGI("	puf_lckwd_020: %8x\r\n", r->puf_lckwd_020);
	SOC_LOGI("	puf_lckwd_021: %8x\r\n", r->puf_lckwd_021);
	SOC_LOGI("	puf_lckwd_022: %8x\r\n", r->puf_lckwd_022);
	SOC_LOGI("	puf_lckwd_023: %8x\r\n", r->puf_lckwd_023);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_lckwd_024: %8x\r\n", r->puf_lckwd_024);
	SOC_LOGI("	puf_lckwd_025: %8x\r\n", r->puf_lckwd_025);
	SOC_LOGI("	puf_lckwd_026: %8x\r\n", r->puf_lckwd_026);
	SOC_LOGI("	puf_lckwd_027: %8x\r\n", r->puf_lckwd_027);
	SOC_LOGI("	puf_lckwd_028: %8x\r\n", r->puf_lckwd_028);
	SOC_LOGI("	puf_lckwd_029: %8x\r\n", r->puf_lckwd_029);
	SOC_LOGI("	puf_lckwd_030: %8x\r\n", r->puf_lckwd_030);
	SOC_LOGI("	puf_lckwd_031: %8x\r\n", r->puf_lckwd_031);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_lckwd_240: %8x\r\n", r->puf_lckwd_240);
	SOC_LOGI("	puf_lckwd_241: %8x\r\n", r->puf_lckwd_241);
	SOC_LOGI("	puf_lckwd_242: %8x\r\n", r->puf_lckwd_242);
	SOC_LOGI("	puf_lckwd_243: %8x\r\n", r->puf_lckwd_243);
	SOC_LOGI("	puf_lckwd_244: %8x\r\n", r->puf_lckwd_244);
	SOC_LOGI("	puf_lckwd_245: %8x\r\n", r->puf_lckwd_245);
	SOC_LOGI("	puf_lckwd_246: %8x\r\n", r->puf_lckwd_246);
	SOC_LOGI("	puf_lckwd_247: %8x\r\n", r->puf_lckwd_247);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_lckwd_248: %8x\r\n", r->puf_lckwd_248);
	SOC_LOGI("	puf_lckwd_249: %8x\r\n", r->puf_lckwd_249);
	SOC_LOGI("	puf_lckwd_250: %8x\r\n", r->puf_lckwd_250);
	SOC_LOGI("	puf_lckwd_251: %8x\r\n", r->puf_lckwd_251);
	SOC_LOGI("	puf_lckwd_252: %8x\r\n", r->puf_lckwd_252);
	SOC_LOGI("	puf_lckwd_253: %8x\r\n", r->puf_lckwd_253);
	SOC_LOGI("	puf_lckwd_254: %8x\r\n", r->puf_lckwd_254);
	SOC_LOGI("	puf_lckwd_255: %8x\r\n", r->puf_lckwd_255);
}

static void otp_dump_rsv_40_7f(void)
{
	for (uint32_t idx = 0; idx < 64; idx++) {
		SOC_LOGI("rsv_40_7f: %8x\r\n", REG_READ(SOC_OTP_REG_BASE + ((0x40 + idx) << 2)));
	}
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	intrpt_st: %8x\r\n", r->intrpt_st);
	SOC_LOGI("	reserved_10_15: %8x\r\n", r->reserved_10_15);
	SOC_LOGI("	intrpt_en: %8x\r\n", r->intrpt_en);
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	puf_psmsk: %8x\r\n", r->puf_psmsk);
	SOC_LOGI("	reserved_8_23: %8x\r\n", r->reserved_8_23);
	SOC_LOGI("	lck_psmsk: %8x\r\n", r->lck_psmsk);
}
...
static void otp_dump_(void)
{
	...
	SOC_LOGI("	pdstb: %8x\r\n", r->pdstb);
	SOC_LOGI("	clkosc_en: %8x\r\n", r->clkosc_en);
	SOC_LOGI("	reserved_2_3: %8x\r\n", r->reserved_2_3);
	SOC_LOGI("	rd_mode: %8x\r\n", r->rd_mode);
	SOC_LOGI("	rd_to_sel: %8x\r\n", r->rd_to_sel);
	SOC_LOGI("	fre_cont: %8x\r\n", r->fre_cont);
	SOC_LOGI("	reserved_9_10: %8x\r\n", r->reserved_9_10);
	SOC_LOGI("	ht_rd: %8x\r\n", r->ht_rd);
	SOC_LOGI("	reserved_12_23: %8x\r\n", r->reserved_12_23);
	SOC_LOGI("	ptc_page: %8x\r\n", r->ptc_page);
}

static void otp_dump_rsv_b3_b3(void)
{
	for (uint32_t idx = 0; idx < 1; idx++) {
		SOC_LOGI("rsv_b3_b3: %8x\r\n", REG_READ(SOC_OTP_REG_BASE + ((0xb3 + idx) << 2)));
	}
}
