...
/* REG_0x00 */
static inline uint32_t dma2d_ll_get_device_id(dma2d_hw_t *hw)
{
    return hw->device_id;
}

/* REG_0x01 */
static inline uint32_t dma2d_ll_get_version_id(dma2d_hw_t *hw)
{
...
/* REG_0x02 */
static inline uint32_t dma2d_ll_get_module_control_soft_reset(dma2d_hw_t *hw)
{
    return hw->module_control.soft_reset;
}

static inline uint32_t dma2d_ll_set_module_control_soft_reset(dma2d_hw_t *hw, uint32_t value)
{
	hw->module_control.soft_reset = value;
}

/* REG_0x03 */
static inline uint32_t dma2d_ll_get_global_status(dma2d_hw_t *hw)
{
    return hw->global_status;
}
...
/* REG_0x04:dma2d_control_reg->tran_start:dma2d transfer start.,RW,0x0[       0]*/
...
/* REG_0x04:dma2d_control_reg->tran_suspend:dma2d transfer start.,RW,0x0[       1]*/
...
/* REG_0x04:dma2d_control_reg->tran_abort:dma2d transfer start.,RW,0x0[       2]*/
...
/* REG_0x04:dma2d_control_reg->line_offset_mode:line's offset mode sel: 0:in pixel express; 1: in bytes express.,RW,0x0[       6]*/
...
/* REG_0x04:dma2d_control_reg->error_int_en:trabsfer error int ena.,RW,0x0[       8]*/
...
/* REG_0x04:dma2d_control_reg->complete_int_en:transfer complete int ena.,RW,0x0[       9]*/
...
/* REG_0x04:dma2d_control_reg->waterm_int_en:transfer watermark int ena.,RW,0x0[     10]*/
...
/* REG_0x04:dma2d_control_reg->clut_error_int_en:clut transfer error int ena.,RW,0x0[     11]*/
...
/* REG_0x04:dma2d_control_reg->clut_cmplt_int_en:clut transfer complete int ena.,RW,0x0[     12]*/
...
/* REG_0x04:dma2d_control_reg->config_error_int_en:config error int ena,,RW,0x0[     13]*/
...
/* REG_0x04:dma2d_control_reg->mode:DMA2D mode sel: 000:m2m; 001:m2m pixel convert with fg; 010:m2m blend; 011:r2m.only with output; 100: m2m blend fix fg; 101:m2m blend fix bg;,RW,0x0[18:16]*/
...
/* REG_0x04:[19:20] max transfer length:00:256bytes; 01:192 bytes;  10:128bytes;  11:64bytes;*/
...
/* REG_0x04:[19:20] dma2dmax transfer length:00:256bytes; 01:192 bytes;  10:128bytes;  11:64bytes;*/
...
/* REG_0x04:[21] in output rgb888 formart, reverse data byte by byte.;*/
...
/* REG_0x05:dma2d_int_status->clut_cmplt_int:clut transfer complete intt flag.,R,0x1[       4]*/
...
/* REG_0x05:dma2d_int_status->config_error_int:config error int t flag.,R,0x1[       5]*/
...
/* REG_0x06:dma2d_int_clear->clr_error_int:clear transfer error int flag.,W,0x2[       0]*/
...
/* REG_0x06:dma2d_int_clear->clr_complete_int:clear transfer complete int flag.,W,0x2[       1]*/
...
/* REG_0x06:dma2d_int_clear->clr_waterm_int:clear transfer watermark intt flag.,W,0x2[       2]*/
...
/* REG_0x06:dma2d_int_clear->clr_clut_error_int:clear clut transfer error intt flag.,W,0x2[       3]*/
...
/* REG_0x06:dma2d_int_clear->clr_clut_cmplt_int:clear clut transfer complete intt flag.,W,0x2[       4]*/
...
/* REG_0x06:dma2d_int_clear->clr_config_error_int:clear config error int t flag.,W,0x2[       5]*/
...
/* REG_0x07:dma2d_fg_address->fg_address:foreground mem address, written when transfer disable.,RW,0x3[31:  0]*/
...
/* REG_0x08:dma2d_fg_offset->fg_line_offset:line offset for fg, offset In pixel or bytes.,RW,0x4[15:  0]*/
...
/* REG_0x09:dma2d_bg_address->bg_address:background mem address, written when transfer disable.,RW,0x5[31:  0]*/
...
/* REG_0x0a:dma2d_bg_offset->bg_line_offset:line offset for bg, offset In pixel or bytes.,RW,0x6[15:  0]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_color_mode:foreground image color mode.; 0000:ARGB888;0001:RGB888;0010:RGB565;0011:ARGB1555;0100:ARGB4444; 0101:L8;0110:AL44; 0111:AL88; 1000:L4; 1001:A8;1010:A4;,RW,0x7[  3:  0]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_clut_color_mode:color mode for clut. 0:argb8888; 1:rgb888.,RW,0x7[       4]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_start_clut:automatic load the clut. Automatic reset.,RW,0x7[       5]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_clut_size:the size of clut used for foreground image. Size = fg_clut_size + 1;,RW,0x7[15:  8]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_alpha_mode:alpha value use for fg image. 00: nochange; 01:replace orginal, 10: alpha[7:0] multipied with orginal value.,RW,0x7[17:16]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->alpha_invert:invert alpha value.,RW,0x7[     20]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_rb_swap:red blue swap to support rgb or argb. 0: regular mode.1:swap_mode.,RW,0x7[     21]*/
...
/* REG_0x0b:dma2d_fg_pfc_ctrl->fg_alpha:fg alpha value set. Use with fg_alpha_mode.,RW,0x7[31:24]*/
...
/* REG_0x0c:dma2d_fg_color_reg->blue_value:blue_value in a4 or a8 mode of fg,,RW,0x8[  7:  0]*/
...
/* REG_0x0c:dma2d_fg_color_reg->green_value:green_value in a4 or a8 mode of fg,,RW,0x8[15:  8]*/
...
/* REG_0x0c:dma2d_fg_color_reg->red_value:red_value in a4 or a8 mode of fg,,RW,0x8[23:16]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_color_mode:background image color mode.; 0000:ARGB888;0001:RGB888;0010:RGB565;0011:ARGB1555;0100:ARGB4444; 0101:L8;0110:AL44; 0111:AL88; 1000:L4; 1001:A8;1010:A4;,RW,0x9[  3:  0]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_clut_color_mode:color mode for clut. 0:argb8888; 1:rgb888.,RW,0x9[       4]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_start_clut:automatic load the clut. Automatic reset.,RW,0x9[       5]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_clut_size:the size of clut used for background image. Size = fg_clut_size + 1;,RW,0x9[15:  8]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_alpha_mode:alpha value use for fg image. 00: nochange; 01:replace orginal, 10: alpha[7:0] multipied with orginal value.,RW,0x9[17:16]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->alpha_invert:invert alpha value.,RW,0x9[     20]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_rb_swap:red blue swap to support rgb or argb. 0: regular mode.1:swap_mode.,RW,0x9[     21]*/
...
/* REG_0x0d:dma2d_bg_pfc_ctrl->bg_alpha:bg alpha value set. Use withbg_alpha_mode.,RW,0x9[31:24]*/
...
/* REG_0x0e:dma2d_bg_color_reg->blue_value:blue_value in a4 or a8 mode of bg,,RW,0xa[  7:  0]*/
...
/* REG_0x0e:dma2d_bg_color_reg->green_value:green_value in a4 or a8 mode of bg,,RW,0xa[15:  8]*/
...
/* REG_0x0e:dma2d_bg_color_reg->red_value:red_value in a4 or a8 mode of bg,,RW,0xa[23:16]*/
...
/* REG_0x0f:fg_clut_mem_address->fg_clut_address:clut data dedicated to the fg image.,RW,0xb[31: 0]*/
...
/* REG_0x10:bg_clut_mem_address->bg_clut_address:clut data dedicated to the bg image.,RW,0xc[31:  0]*/
...
/* REG_0x11:out_pfc_contrl->out_color_mode:format of output image.0:argb888; 1:rgb888; 010:rgb565; 011:argb1555; 100:argb444,RW,0xd[  2:  0]*/
...
/* REG_0x11:out_pfc_contrl->out_swap_bytes:0:bytes in regular order. 1:bytes swaped two by two in output fifo.,RW,0xd[       9]*/
...
/* REG_0x11:out_pfc_contrl->out_rb_swap:ed blue swap to support rgb or argb. 0: regular mode.1:swap_mode.,RW,0xd[     21]*/
...
/* REG_0x12:out_color_reg->output_clor_reg:output reg, in different color mode. Output is different.; Argb888 or rgb888: alpha[31:24];red[23:16]; green[15:8];blue[7:0].; Rgb565:red[15:11]; green[12:5]; blue[4:0];; argb1555:a[15];red[14:10]; green[4:0]; blue[4:0];; argb4444:alpha[15:12];red[11:8];green[7:4];blue[3;0].,RW,0xe[31:  0]*/
...
/* REG_0x13:dma2d_out_mem_address->out_mem_address:address of data output fifo.,RW,0xf[31:  0]*/
...
/* REG_0x14:output_offset->out_line_offset:output line offset. Offfset with bytes or pixel.in pixel[15:14] ignored.,RW,0x10[15:  0]*/
...
/* REG_0x15:dma2d_number_of_line->number_line:X PIXEL.,RW,0x11[15:  0]*/
...
/* REG_0x15:dma2d_number_of_line->pixel_line:Y_PIXEL.,RW,0x11[29:16]*/
...
/* REG_0x16:dma2d_line_watermark->line_watermark:config the line watermark int generation, transfer reach the watermark, int hold on.,RW,0x12[15:  0]*/
...
/* REG_0x17:dma2d_master_time_config->master_time_ena:enable dead time function.,RW,0x18[       0]*/
