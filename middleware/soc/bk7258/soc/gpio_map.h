...
{\
	...
	{GPIO_14, GPIO_SECOND_FUNC_ENABLE, GPIO_DEV_LCD_RGB20, GPIO_IO_DISABLE, GPIO_PULL_DISABLE, GPIO_INT_DISABLE, GPIO_INT_TYPE_LOW_LEVEL, GPIO_LOW_POWER_DISCARD_IO_STATUS, GPIO_DRIVER_CAPACITY_3},\
