...
#define I2S1_DEVICE_ID_ADDR               (I2S1_LL_REG_BASE + (0x0 << 2))
#define I2S2_DEVICE_ID_ADDR               (I2S2_LL_REG_BASE + (0x0 << 2))

#define I2S_VERSION_ID_ADDR               (I2S_LL_REG_BASE  + (0x1 << 2))
#define I2S1_VERSION_ID_ADDR              (I2S1_LL_REG_BASE + (0x1 << 2))
#define I2S2_VERSION_ID_ADDR              (I2S2_LL_REG_BASE + (0x1 << 2))

#define I2S_CLK_RST_ADDR                  (I2S_LL_REG_BASE  + (0x2 << 2))
#define I2S1_CLK_RST_ADDR                 (I2S1_LL_REG_BASE + (0x2 << 2))
#define I2S2_CLK_RST_ADDR                 (I2S2_LL_REG_BASE + (0x2 << 2))
...
#define I2S1_DEV_STATUS_ADDR              (I2S1_LL_REG_BASE + (0x3 << 2))
#define I2S2_DEV_STATUS_ADDR              (I2S2_LL_REG_BASE + (0x3 << 2))

#define I2S_PCM_CONF_ADDR                 (I2S_LL_REG_BASE  + (0x4 << 2))
#define I2S1_PCM_CONF_ADDR                (I2S1_LL_REG_BASE + (0x4 << 2))
#define I2S2_PCM_CONF_ADDR                (I2S2_LL_REG_BASE + (0x4 << 2))
...
#define I2S1_PCM_CN_ADDR                  (I2S1_LL_REG_BASE + (0x5 << 2))
#define I2S2_PCM_CN_ADDR                  (I2S2_LL_REG_BASE + (0x5 << 2))
...
#define I2S1_PCM_STAT_ADDR                (I2S1_LL_REG_BASE + (0x6 << 2))
#define I2S2_PCM_STAT_ADDR                (I2S2_LL_REG_BASE + (0x6 << 2))
...
#define I2S1_PCM_DAT_ADDR                 (I2S1_LL_REG_BASE + (0x7 << 2))
#define I2S2_PCM_DAT_ADDR                 (I2S2_LL_REG_BASE + (0x7 << 2))

#define I2S_PCM_CN_LT2_ADDR               (I2S_LL_REG_BASE  + (0x8 << 2))
#define I2S1_PCM_CN_LT2_ADDR              (I2S1_LL_REG_BASE + (0x8 << 2))
#define I2S2_PCM_CN_LT2_ADDR              (I2S2_LL_REG_BASE + (0x8 << 2))
...
#define I2S1_PCM_STAT_LT2_ADDR            (I2S1_LL_REG_BASE + (0x9 << 2))
#define I2S2_PCM_STAT_LT2_ADDR            (I2S2_LL_REG_BASE + (0x9 << 2))
...
#define I2S1_PCM_DAT2_ADDR                (I2S1_LL_REG_BASE + (0xA << 2))
#define I2S2_PCM_DAT2_ADDR                (I2S2_LL_REG_BASE + (0xA << 2))

#define I2S_PCM_DAT3_ADDR                 (I2S_LL_REG_BASE  + (0xB << 2))
#define I2S1_PCM_DAT3_ADDR                (I2S1_LL_REG_BASE + (0xB << 2))
#define I2S2_PCM_DAT3_ADDR                (I2S2_LL_REG_BASE + (0xB << 2))

#define I2S_PCM_DAT4_ADDR                 (I2S_LL_REG_BASE  + (0xC << 2))
#define I2S1_PCM_DAT4_ADDR                (I2S1_LL_REG_BASE + (0xC << 2))
#define I2S2_PCM_DAT4_ADDR                (I2S2_LL_REG_BASE + (0xC << 2))
