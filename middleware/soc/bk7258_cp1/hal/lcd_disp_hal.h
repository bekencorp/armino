...
#define BK7236_DISP_BASE_ADDR                    0x48060000
#define reg_DISP_DEVICE_ID                (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+0*4)))
#define reg_DISP_VERSION_ID               (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+1*4)))
#define reg_DISP_MODULE_CONTROL           (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+2*4)))
#define reg_DISP_GLOBAL_STATUS            (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+3*4)))
#define reg_DISP_INT_CONFIG               (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+4*4)))
#define reg_DISP_RGB_CONFIG               (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+5*4)))
#define reg_DISP_RGB_FIFO                 (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+6*4)))
#define reg_DISP_SYNC_CONFIG              (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+7*4)))
#define reg_DISP_I8080_CONFIG             (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+8*4)))
#define reg_DISP_CMD_FIFO                 (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+9*4)))
#define reg_DISP_DAT_FIFO                 (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+10*4)))
#define reg_DISP_I8080_THRD               (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+11*4)))
#define reg_DISP_STATUS                   (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+12*4)))
#define reg_DISP_SYNC_LOW                 (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+13*4)))
#define reg_DISP_PARTIAL1                 (*((volatile unsigned long *)   (BK7236_DISP_BASE_ADDR+14*4)))
