...
#define UART_LL_REG_BASE(_uart_unit_id) (SOC_UART_REG_BASE + (0x40 * _uart_unit_id))
#define CASE_PARITY(parity) case UART_PARITY_##parity: return UART_V_PARITY_##parity
#define CASE_D() default: return 0

#define UART1_LL_TX_PIN    GPIO_0
#define UART1_LL_RX_PIN    GPIO_1

#define UART2_LL_TX_PIN    GPIO_6
#define UART2_LL_RX_PIN    GPIO_7

#define UART3_LL_TX_PIN    GPIO_34
#define UART3_LL_RX_PIN    GPIO_35
...
static inline uint32_t uart_ll_wait_tx_over(void)
{
	...
	uart_hw_t *hw3 = (uart_hw_t *)UART_LL_REG_BASE(2);
	...
	uart_wait_us = 1000000 * hw2->fifo_status.tx_fifo_count * 10 / baudrate2
				 ...
				 + 1000000 * hw3->fifo_status.tx_fifo_count * 10 / baudrate3;
