...
void ui_UiPage5_screen_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_text_font(ui_Ui5Tittle, &ui_font_PingFangCN32, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Ui5Label1, &ui_font_OppoCN24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Ui5Label2, &ui_font_OppoCN24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Ui5Label3, &ui_font_OppoCN24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Ui5Label4, &ui_font_OppoCN24, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui_Ui5Label5, &ui_font_OppoCN24, LV_PART_MAIN | LV_STATE_DEFAULT);
