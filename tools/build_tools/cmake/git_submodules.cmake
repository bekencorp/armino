...
if(NOT GIT_FOUND)
    LOGW("Git executable was not found. Git submodule checks will not be executed. "
    ...
    function(git_submodule_check root_path)
        ...
        foreach(line ${submodule_status})
            ...
            if("${status}" STREQUAL "-")  # missing submodule
                LOGI("Initialising new submodule ${submodule_path}...")
                execute_process(
                ...
                if(git_result)
                    LOGE("Git submodule init failed for ${submodule_path}")
                endif()

            elseif(NOT "${status}" STREQUAL " ")
                LOGW("Git submodule ${submodule_path} is out of date. "
