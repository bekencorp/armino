...
function(target_linker_script_judge)
	...
	if (EXISTS ${armino_path}/$ENV{PROJECT_DIR}/${target}/${target}_bsp.sag)
		set(sag_file ${armino_path}/$ENV{PROJECT_DIR}/${target}/${target}_bsp.sag)
		set(ld_file ${armino_path}/$ENV{PROJECT_DIR}/${target}/${target}_bsp.ld)
	elseif(EXISTS ${armino_path}/$ENV{PROJECT_DIR}/${target}_bsp.sag)
		set(sag_file ${armino_path}/$ENV{PROJECT_DIR}/${target}_bsp.sag)
	...
	if(${ldsag_flag} STREQUAL 1)
		...
		elseif(EXISTS ${armino_path}/$ENV{PROJECT_DIR}/${target}/${target}_bsp.ld)
			set(ld_file ${armino_path}/$ENV{PROJECT_DIR}/${target}/${target}_bsp.ld)
		elseif(EXISTS ${armino_path}/$ENV{PROJECT_DIR}/${target}_bsp.ld)
			set(ld_file ${armino_path}/$ENV{PROJECT_DIR}/${target}_bsp.ld)
